...
(function (root, factory) {
    ...
    _extGetter = (process && process.platform === 'win32') ? require('./extensions/getter') : function (path) {
        var last        = null,
            splitPathRe = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/;
    ...
    Mimer.prototype = {
        ...
        list: (process && process.cwd) ? require('./data/parser')(process.cwd() + '/lib/data/mime.types') : $_MIMER_DATA_LIST
    };
